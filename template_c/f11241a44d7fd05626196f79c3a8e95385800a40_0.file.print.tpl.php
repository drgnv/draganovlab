<?php
/* Smarty version 3.1.32, created on 2019-05-19 14:33:18
  from 'C:\xampp\htdocs\draganovlab402\view\print.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5ce14d0ec02038_27744346',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f11241a44d7fd05626196f79c3a8e95385800a40' => 
    array (
      0 => 'C:\\xampp\\htdocs\\draganovlab402\\view\\print.tpl',
      1 => 1557675553,
      2 => 'file',
    ),
  ),
...
function content_5ce14d0ec02038_27744346 (Smarty_Internal_Template $_smarty_tpl) {
?><style>
    @media print {
...
if ($_prefixVariable8) {?> Седимент: <?php }?> <?php ob_start();
echo $_smarty_tpl->tpl_vars['tests']->value['shit'];
$_prefixVariable9 = ob_get_clean();
if ($_prefixVariable9) {?> Окултен кръвоизлив:
                    <br><?php }?> <?php ob_start();
echo $_smarty_tpl->tpl_vars['tests']->value['ourine'];
$_prefixVariable10 = ob_get_clean();
if ($_prefixVariable10) {?> Микроалбуминурия:
                    <br><?php }?>
                </td>
            </tr>
        </tbody>
...
if ($_prefixVariable17 && $_prefixVariable18) {?> , <?php }?> <?php ob_start();
echo $_smarty_tpl->tpl_vars['tests']->value['akr'];
$_prefixVariable19 = ob_get_clean();
if ($_prefixVariable19) {?> АКР - капилярно <?php }?> <?php ob_start();
echo $_smarty_tpl->tpl_vars['tests']->value['dif'];
$_prefixVariable20 = ob_get_clean();
if ($_prefixVariable20) {?> Диференциално броене на левкоцити <?php }?>
                </td>
            </tr>
        </tbody>
    </table>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> <?php }?> <?php ob_start();
echo $_smarty_tpl->tpl_vars['tests']->value['ele'];
$_prefixVariable26 = ob_get_clean();
if ($_prefixVariable26) {?> <?php
