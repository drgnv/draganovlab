...
<div class="content">
    ...
    <div class="center">
        <div class="edit-doctors">
            <h1 style=" font-size: 25px;">{$lang.electro}</h1> {include file="tests_menu.tpl"}
            <hr>
            ...
            <table id="tests" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="text-decoration: none;" href="../controller/edit__ele_component.php?id={{$test.id}}" onclick="window.open('../controller/edit_ele_component.php?id={{$test.id}}', 
                         'newwindow', 
                         'width=320,height=260');
              return false;" >
                                <img src="../images/edit.png" width="30" height="30" > {$lang.edit}
                            </a>

                            <a style="text-decoration: none;" href="../controller/edit_electrolites.php?delete={$test.id}" onclick="return confirm('Сигурен ли сте, че искате да изтриете: {$test.name}?')" title="Изтрий {$result.names}"><img src="../images/delete.png" width="25" height="25"> {$lang.delete}</a>
